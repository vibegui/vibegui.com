  ...
  return (
    <article className="container py-8 md:py-12">
      ...
      <div className="prose mx-auto">
        ...
        <p>
          One of our main projects is Maratona Tech—Brazil's largest technology
          olympiad, created to spark students' interest in technology. It's not
          just a competition, it's a gateway to a universe of possibilities that
          previously seemed unattainable for millions of young Brazilians.
        </p>

        <blockquote>
          <p>
            Talent is equally distributed; opportunity is not. And technology is
            the most powerful bridge to correct this asymmetry.
          </p>
        </blockquote>
        ...
        <p>
          <strong>
            It's a long-term game. A country game. And it's exactly the kind of
            game worth playing.
          </strong>
        </p>
      </div>
