...
function generateManifest() {
  ...
  const files = readdirSync(articlesDir).filter(f => f.endsWith(".md") && !f.startsWith("."));
  ...
  writeFileSync(resolve(publicContentDir, "manifest.json"), JSON.stringify(manifest, null, 2));
